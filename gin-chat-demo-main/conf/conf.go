...
func LoadPath(file *ini.File) {
	PersonalPath = file.Section("path").Key("PersonalPath").String()
	DataPath = file.Section("path").Key("DataPath").String()
}
func LoadEmail(file *ini.File) {
	EmailHost = file.Section("Email").Key("EmailHost").String()
	EmailPort = file.Section("Email").Key("EmailPort").String()
	EmailUser = file.Section("Email").Key("EmailUser").String()
